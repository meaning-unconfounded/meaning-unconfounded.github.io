...
(function() {
  ...
  (function() {
    // ----- Mapping: keyId -> sectionId (spread across unique sub-anchors) -----
    var keyMap = {
      '01': 'mu-ch1',
      '02': 'mu-intro',
      '03': 'mu-ch9',
      '04': 'mu-ch8',
      '05': 'mu-ch13',
      // Key 06 updated with new teaser (no cow-example duplication)
      '06': 'mu-ch5',
      // Key 07 remapped to Chapter 31 (Inversion Cosmology)
      '07': 'mu-ch31',
      '08': 'mu-ch7',
      '09': 'mu-ch8b',      // sub-anchor inside Chapter 8 (N-time sidebar)
      '10': 'mu-ch16b',     // sub-anchor: Body-as-Pronunciation
      '11': 'mu-ch3',
      '12': 'mu-ch14',
      '13': 'mu-ch12',
      '14': 'mu-ch9b',      // sub-anchor: Silent Consonant Proof
      '15': 'mu-ch10',
      '16': 'mu-ch10b',     // sub-anchor: Consciousness self-describes
      '17': 'mu-ch16c',     // sub-anchor: Frozen Conflict as Mass
      '18': 'mu-ch16d',     // sub-anchor: Emotions as Radiating
      '19': 'mu-ch16e',     // sub-anchor: Body Map
      '20': 'mu-interlude',
      '21': 'mu-ch15',
      '22': 'mu-ch16f',     // sub-anchor: Frozen Postulates (4 traits)
      '23': 'mu-ch6',
      '24': 'mu-ch5b',      // sub-anchor: Math is Objective (within Chapter 5)
      '25': 'mu-ch27',
      '26': 'mu-ch30',
      '27': 'mu-ch30b',     // sub-anchor: Space Bar = Breath
      '28': 'mu-ch30c',     // sub-anchor: Punctuation as Operators
      '29': 'mu-ch12b',     // sub-anchor: THE vs A
      '30': 'mu-app-o',
      '31': 'mu-ch23',
      '32': 'mu-ch19',
      '33': 'mu-ch26',
      ...
      '35': 'mu-prologue',
      '36': 'mu-app-p',
      '37': 'mu-app-p2',    // sub-anchor: Master Numbers
      '38': 'mu-app-h',
      '39': 'mu-app-b',
      '40': 'mu-ch11'
    };
    ...
    function processQueue() {
      ...
      // Reveal the key (this logic is from the observer trigger)
    ...
    function queueReveal(kid) {
      // Only queue if not already in queue and not already revealed
      if (revealQueue.some(function(item) { return item.kid === kid; })) return;
      // Check if key is already visible
      var el = keyElements[kid];
    ...
    var sectionObserver = new IntersectionObserver(function(entries) {
      entries.forEach(function(entry) {
        ...
        if (entry.isIntersecting) {
          // Section is becoming visible – queue the key reveal
          queueReveal(kid);
        } else {
          // Section scrolled out – ghost if not engaged
    ...
    // Observe the sections (and sub-anchors)
    for (var kid in keyMap) {
      var secId = keyMap[kid];
      var secEl = document.getElementById(secId);
      if (secEl) {
        sectionObserver.observe(secEl);
      }
    }

    // ----- Click to engage / expand -----
    ...
    // No forced reveal on load – observer and queue handle all visibility
  })();
