...
(function() {
  ...
  const decoderDictionary = {
    ...
    "chase": { hebrewRoot: "SHESA", hebrewChars: "שיסה", hebrewMeaning: "CHASE", traditional: "Latin – CAPTATE = TO STRIVE TO SEIZE.", notes: "", architecture: "C+H+S", insight: "Contain + Breath + Spread — to chase is to spread breath in containment, to pursue.", bookRef: "" },
...
/* ── Universal Carousel (multiple instances) ── */
(function() {
  function initCarousel(container) {
    var track = container.querySelector('.univers-track');
    if (!track) return;
    var slides = track.querySelectorAll('.univers-slide');
    var dots = container.querySelectorAll('.univers-dot');
    var prevBtn = container.querySelector('.univers-btn.prev');
    var nextBtn = container.querySelector('.univers-btn.next');
    var currentIndex = 0;
    ...
    document.addEventListener('keydown', function(e) {
      ...
      if (!isVisible) return;
      if (e.key === 'ArrowRight') { resetAutoplay(); nextSlide(); e.preventDefault(); }
