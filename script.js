...
(function() {
  ...
  (function() {
    ...
    // State: dismissed keys (persists across sessions)
    ...
    function isDismissed(id) { return dismissed.includes(id); }
    ...
    // Seen keys (for playing sound only once)
    ...
    function isSeen(id) { return seen.includes(id); }
    ...
    function updateTracker() {
      ...
      if (bar && total > 0) bar.style.width = (found / total * 100) + '%';
    ...
    // Click on card → dismiss immediately
